...
- Supported 2021.04/2022.07 Version of Platform

### Steps

``` bash
composer require skynettechnologies/aimeos-accessibility-extension
```
...
## Live Demo
https://aimeosreact.skynettechnologies.us/
...
- [Purchase Aimeos All in One Accessibility](https://www.skynettechnologies.com/aimeos-accessibility-widget)
- [How to install All in One Accessibility Addon on Aimeos](https://www.skynettechnologies.com/blog/aimeos-web-accessibility-widget-installation)
